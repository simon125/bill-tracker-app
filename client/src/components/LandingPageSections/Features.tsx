    ...
    >
      ...
      <FeaturesContainer>
        ...
        <Feature>
          ...
          <Paragraph color="grey">
            You don't need to enter prices, dates names of shops, with this app
            you can store your bills in image format. Do shoppings, take bill
            and then take a photo of the bill.
          </Paragraph>
        </Feature>
        <Feature>
          <FeatureIconWrapper>
          ...
          <Paragraph color="grey">
            ...
            additional information - thanks that you would have any information
            you need.
          </Paragraph>
        </Feature>
        <Feature>

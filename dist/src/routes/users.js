...
router.post('/', [
    ...
    var errors, _a, name, email, password, user, salt, _b, _c, payload, error_1;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 4:
                user = new (_b.apply(User_1.default, [void 0, (_c.password = _d.sent(),
                        _c)]))();
            ...
            case 5:
                ...
                jsonwebtoken_1.default.sign(payload, config_1.default.get('jwtSecret'), { expiresIn: '1h' }, function (err, token) {
                    if (err) {
                        throw err;
                    }
